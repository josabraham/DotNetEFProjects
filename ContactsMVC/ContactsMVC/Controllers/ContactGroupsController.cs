...
namespace ContactsMVC.Controllers
{
    ...
    {
        private ContactsMVCDBContext db = new ContactsMVCDBContext();
        ...
        public ActionResult Create([Bind(Include = "ContactGroupId,GroupName")] ContactGroup contactGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactGroupId,GroupName")] ContactGroup contactGroup)
        {
            if (ModelState.IsValid)
            {
