...
namespace ContactsMVCCore_SQLite.Controllers
{
    public class ContactGroupsController : Controller
    {
        ...
        public ContactGroupsController(ContactsMVCCoreSQLiteDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ContactGroups != null ? 
                          ...
                          Problem("Entity set 'ContactsMVCCoreSQLiteDBContext.ContactGroups'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContactsMVCCoreSQLiteDBContext.ContactGroups'  is null.");
            }
            var contactGroup = await _context.ContactGroups.FindAsync(id);
            if (contactGroup != null)
            {
